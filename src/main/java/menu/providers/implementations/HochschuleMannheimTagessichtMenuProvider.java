    ...
    public CompletableFuture<List<MenuItem>> getMenuItemsForDate(MenuTime date) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                final Document document = SiteFetcher.performPostAndParseHtml("https://www.stw-ma.de/Essen+_+Trinken/Speisepl%C3%A4ne/Hochschule+Mannheim.html", formBody, headers);
